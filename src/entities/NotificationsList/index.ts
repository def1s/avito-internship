export { notificationsListReducer, notificationsListActions } from './model/slice/notificationsListSlice';

export { NotificationsListSchema } from './model/types/notificationsListSchema';
